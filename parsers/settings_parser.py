        ...
        try:
            ...
            for line in lines:
                ...
                if not line.startswith('!'):
                    # Stop parsing if we encounter a non-comment line early on
                    if len(line) > 0: # Ignore blank lines between comments
                         break
                    else:
                         continue # Skip blank lines

                # Example: ! File generated by DesignBuilder - 7.3.1.003 18/04/2025 - 18:22:25
                ...
                # Example: ! Geometry convention template : ASHRAE 90.1
                parts = line[1:].split(':', 1) # Split after '!'
                if len(parts) == 2:
